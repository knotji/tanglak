...
function resolveDebtCycleRollover(
  ...
  todayKey: string,
): { cycleStartDate: string; cycleEndDate: string; dueDate?: string } | null {
  const baseline =
  ...
  return { cycleStartDate: window.cycleStartDate, cycleEndDate: window.cycleEndDate, dueDate: newDueDate };
}
